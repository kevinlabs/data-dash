...
module.exports = {
  getWeather: function(req, res) {
    ...
    return axios.get(baseUrl+req.body.zipcode+',us'+'&appid='+keys.weatherKey).then((response) => {
...
//api.openweathermap.org/data/2.5/weather?zip=94040,us&appid=c54910d1ae4d8e9e7e5bbda457d4ba22
